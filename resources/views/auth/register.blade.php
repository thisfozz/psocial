...
@section('content')
    <div class="terminal-window-register">
        <div class="terminal-window-bar-register">
            <span class="terminal-window-btn-register close"></span>
            <span class="terminal-window-btn-register minimize"></span>
            <span class="terminal-window-btn-register zoom"></span>
